...
def main():
	...
	with tf.variable_scope("conv7"):
		...
		maxpool7 = tf.layers.max_pooling2d(conv7, pool_size=(2, 2), strides=(2, 2), padding="same")
	...
	with tf.variable_scope("conv8"):
		...
		maxpool8 = tf.layers.max_pooling2d(conv8, pool_size=(2, 2), strides=(2, 2), padding="same")
